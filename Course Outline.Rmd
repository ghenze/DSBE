...
---
title: "Data Science for Energy and Buildings"
output:
  html_document:
    number_sections: yes
    toc: yes
...
#. Assume Ch. 1-3 (Reddy) 
#. Review (Reddy):
    - Chapter 2.3 - Probability Distribution Functions
        + Parameter Estimation
            - Methods of Moments
            - Maximum Liklihood Estimation (MLE)
            - Bayesian
    - Chapter 2.5 - Bayesian probability
    - Chapter 3.4 - Descriptive Measures for Sample Data
